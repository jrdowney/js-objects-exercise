// object literal for the pet salon information
const salon ={
...
class Pet{
    constructor(name,age,breed,gender,service,ownerName,contactPhone) {
        ...
        this.id='pet'+c; // assiging the id to the pet
...
//create two objects
const Scooby = new Pet("Scooby",60,"Dane","Male","Full Service","Shaggy","56897889");
salon.pets.push(Scooby);
displayTable(Scooby);

const Karmady = new Pet("Karmady",7,"Bengal","Female","Full Service","Jonathan","9015555555");
